...
from dandy.infrastructure.http.intelligence.intel import HttpResponseIntel
from dandy.domain.llm.exceptions import LlmCriticalError, LlmRecoverableError
from dandy.domain.llm.tool.intel import LlmToolCallsIntel
from dandy.domain.tool.tool import BaseTool

from tests.application.llm.tool.intelligence.intel import FinalAnswerIntel
from tests.application.llm.tool.intelligence.tools import ToolBot, WeatherTool
...
class TestLlmToolService(TestCase):
    @mock.patch('dandy.infrastructure.http.connector.HttpConnector.request_to_response')
