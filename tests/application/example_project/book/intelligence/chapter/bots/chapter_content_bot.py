...
from tests.application.example_project.book.intelligence.chapter.prompts import (
    chapter_intel_overview_prompt,
)
from tests.application.example_project.book.intelligence.prompts import book_intel_prompt

if TYPE_CHECKING:
    from tests.application.example_project.book.intelligence.chapter.intel import ChapterIntel
