...
from tests.application.example_project.book.intelligence.character.intel import CharacterIntel
from tests.application.example_project.book.intelligence.character.prompts import (
    characters_intel_prompt,
)

if TYPE_CHECKING:
    from tests.application.example_project.book.intelligence.character.enums import CharacterType
