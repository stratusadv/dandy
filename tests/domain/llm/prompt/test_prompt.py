...
class TestPrompt(TestCase):
    def test_prompt(self):
        new_prompt = Prompt().text("Hello World")
    ...
    def test_prompt_snippets(self):
        ...
        another_prompt = Prompt().text("Hello from another prompt")
        ...
        new_prompt = (
            ...
            .file(
                file_path=Path(
                    ...
                    "assets/documents/basic_document.md",
                )
            )
            .file(
                file_path=Path(
                    Path(__file__).parent.parent.parent.parent.resolve(),
                    "assets/documents/complex_markdown.md",
                )
            )
            ...
            .module_source(module_name="dandy.application.bot.bot")
            .object_source(object_module_name="dandy.application.bot.bot.Bot")
    ...
    def test_prompt_pydantic_typing(self):
        ...
        person_intel = PersonIntel(
            name="John", age=30, custom_prompt=Prompt(CUSTOM_PROMPT_STR)
        )
