...
from dandy.shared.conf import default_settings
from dandy.shared.conf import DandySettings, settings
...
class TestSettings(TestCase):
    ...
    @mock.patch('dandy.shared.conf.utils.get_settings_module_name')
