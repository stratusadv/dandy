...
from dandy.interfaces.cli.cli import DandyCli
...
class TestDandyCli(TestCase):
    ...
    @mock.patch('dandy.application.agent.coding_agent.CodingAgent.chat')
    ...
    @mock.patch(
        'dandy.application.agent.coding_agent.CodingAgent.chat', side_effect=RuntimeError('boom')
    )
