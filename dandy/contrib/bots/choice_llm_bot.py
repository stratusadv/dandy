...
class _ChoiceLlmBot(LlmBot, ABC):
    ...
    def process(
            cls,
            user_input: str,
            choices: Union[Type[Enum], List[str], Tuple[str], Dict[str, Any]],
...
class SingleChoiceLlmBot(_ChoiceLlmBot, _ChoiceOverloadMixin):
    ...
    def process(
            ...
            choices: Union[Type[Enum], List[str], Tuple[str], Dict[str, Any]],
            **kwargs
    ) -> Union[Enum, str, int, float, bool, Dict[str, Any], None]:
...
class MultipleChoiceLlmBot(_ChoiceLlmBot, _ChoiceOverloadMixin):
    ...
    def process(
            ...
            choices: Union[Type[Enum], List[str], Tuple[str], Dict[str, Any]],
            **kwargs
    ) -> Union[List[Enum], List[Union[str, int, float, bool]], Dict[str, Any], None]:
