...
from dandy.infrastructure.cache.exceptions import CacheCriticalError
from dandy.shared.constants import CACHE_KEY_HASH_LAYER_LIMIT
...
def convert_to_hashable_str(obj: Any, hash_layer: int = 1) -> str:
    ...
    if hash_layer <= CACHE_KEY_HASH_LAYER_LIMIT:
        try:
            ...
            elif hasattr(obj, 'recorder_event_id'):
